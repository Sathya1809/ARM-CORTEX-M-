...
extern unint32_t _etext;
extern unint32_t _edata;
extern unint32_t _edata;

extern unint32_t _sbss;
extern unint32_t _ebss;
...
uint32_t vector_table[] __attribute__ ((section (".uds_vector")))={  //tells compiler to use different section 
	SRAM_START, //MSP value(Reserved)
        (uint32_t)&Reset_Handler, //since this is a function pointer use type casting
...
void Reset_Handler(void){ 
	//copy .data section to SRAM for temporary access
